            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                  ...
                  <details class="items-details">
                    ...
                    <div class="items-dropdown">
                      <div v-for="item in order.items" :key="item.sku" class="item-entry">
                        ...
                        <span class="item-meta">{{ t('orders.quantity') }}: {{ item.quantity }} @ {{ currencySymbol }}{{ item.unit_cost }} &mdash; {{ t('orders.submitted.days', { count: item.lead_time_days }) }}</span>
                      </div>
                    </div>
                  </details>
                </td>
                ...
                <td class="col-lead-time">
                  <span v-if="order.items?.length">{{ t('orders.submitted.days', { count: maxLeadTime(order) }) }}</span>
                </td>
                <td class="col-status">
